    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'description')->label( Yii::t('main', 'Description') )->textarea(['id' => 'documentlang-description-'.$model->lang]); ?>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'documentlang-description-<?=$model->lang?>', {
