    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'resume')->label( Yii::t('main', 'Resume') )->textarea(['id' => 'leaderlang-resume-'.$model->lang]); ?>

<!--                --><?//= $form->field($model, 'task')->label( Yii::t('main', 'Majburiyatlari') )->textarea(['id' => 'leaderlang-task-'.$model->lang]); ?>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'leaderlang-resume-<?=$model->lang?>', {
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'leaderlang-task-<?=$model->lang?>', {
        filebrowserBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=files',
        filebrowserImageBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=images',
        filebrowserFlashBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=flash',
        filebrowserUploadUrl : '/kcfinder/upload.php?opener=ckeditor&type=files',
