...
<div class="col-md-8">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?= $form->field($model, 'tel_number')->label( Yii::t('main', 'tel_number') ) ?>
...
<div class="col-md-4">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body w-pad">
            ...
            <?= $form->field($model, 'category')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\PostCategory::getModels(),'id','name'),['class'=>'full-width multi']) ?>
            ...
            <?= $form->field($model, 'slider',
                ['options' =>
                    ['class' => 'form-group form-group-default input-group'],
                    'template' => '<label class="inline" for="post-slider">' . Yii::t("main", "Slider") . '</label><span class="input-group-addon bg-transparent">{input}</span>',
                    'labelOptions' => ['class' => 'inline']
                ])->checkbox([
                'data-init-plugin' => 'switchery',
                'data-color' => 'primary'
            ...
            <?= $form->field($model, 'icon')->label( Yii::t('main', 'Иконка') ) ?>
