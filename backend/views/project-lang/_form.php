    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'description')->label( Yii::t('main', 'Description') )->textarea(['id' => 'projectlang-description-'.$model->lang]); ?>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'projectlang-description-<?=$model->lang?>', {
