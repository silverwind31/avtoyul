...
//                    $menuItems[] = ['label' => Yii::t('main', 'Products'), 'icon' => 'fa fa-cube', 'items' => [
//                        ['label' => Yii::t('main', 'All product'), 'url' => '/product/index', 'icon' => 'AP'],
//                        ['label' => Yii::t('main', 'Products Categories'), 'url' => '/product-category/index', 'icon' => 'PC']
//                    ]];
...
//                        //['label' => Yii::t('main', 'Davlat xizmatlari kategoriyalari'), 'url' => '/public-services-category/index', 'icon' => 'DXK'],
//                    ]];
                    $menuItems[] = ['label' => Yii::t('main', 'Davlat xizmatlari'), 'icon' => 'pg-layouts', 'items' => [
                        ['label' => Yii::t('main', 'Davlat xizmatlari'), 'url' => '/public-services/index', 'icon' => 'DX'],
                        ['label' => Yii::t('main', 'Davlat xizmatlari kategoriyalari'), 'url' => '/public-services-category/index', 'icon' => 'DXK'],
                    ]];
//                    $menuItems[] = ['label' => Yii::t('main', 'Hududiy boshqarmalar'), 'icon' => 'pg-layouts', 'items' => [
//                        ['label' => Yii::t('main', 'Hududiy boshqarmalar'), 'url' => '/branch/index', 'icon' => 'HB'],
//                    ]];
//                    $menuItems[] = ['label' => Yii::t('main', 'Loyihalar'), 'icon' => 'pg-layouts', 'items' => [
//                        ['label' => Yii::t('main', 'Loyihalar'), 'url' => '/project/index', 'icon' => 'Lo'],
//                        ['label' => Yii::t('main', 'Loyiha kategoriyalari'), 'url' => '/project-category/index', 'icon' => 'LK'],
//                    ]];
