            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'status',
                    ['options' =>
                        ...
                        'template' => '<label class="inline" for="servicerequestsubject-status-' . $id . '">' . Yii::t("main", "Status") . '</label><span class="input-group-addon bg-transparent">{input}</span>',
                        'labelOptions' => ['class' => 'inline']
                    ])->checkbox([
                    'data-init-plugin' => 'switchery',
                    'data-color' => 'primary',
                    'id' => 'servicerequestsubject-status-' . $id
                ], false);
                ?>
