        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Product Category'), ['/product-category/create'], ['class' => 'btn btn-success']) ?>
...
//                                'parent_id',
                                [
                                        ...
                                        'value' => function($data){
                                            if($data->parent_id == 0){
                                                return "Самостаятельная категория";
                                            }else{
                                                return \common\models\ProductCategory::findOne($data->parent_id)->name;
                                            }
                                        }
                                ],
                                'name',
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/product-category/index']);?>
