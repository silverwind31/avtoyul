...
$this->title = Yii::t('main', 'Company Appeals');
        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Company Appeal'), ['/company-signup/create'], ['class' => 'btn btn-success']) ?>
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/company-signup/index']);?>
