    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  <?= $form->field($model, 'leader_info')->label( Yii::t('main', 'leader_info') )->textarea(); ?>
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body w-pad">
                ...
                <?= $form->field($model, 'district_id')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\District::find()->all(),'id','name'),['class'=>'full-width multi']) ?>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'branch-leader_info', {
