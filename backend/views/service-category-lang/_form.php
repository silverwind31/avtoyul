        ...
        <div class="panel-body w-pad">
            ...
            <?= $form->field($model, 'status',
                ['options' =>
                    ...
                    'template' => '<label class="inline" for="servicecategorylang-status-' . $model->lang . '">' . Yii::t("main", "Status") . '</label><span class="input-group-addon bg-transparent">{input}</span>',
                    'labelOptions' => ['class' => 'inline']
                ])->checkbox([
                'data-init-plugin' => 'switchery',
                'data-color' => 'primary',
                'id' => 'servicecategorylang-status-' . $model->lang
            ], false);
            ?>
