    ...
    <div class="col-md-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  <?= $form->field($model, 'resume')->label( Yii::t('main', 'Resume') )->textarea(); ?>

<!--                  --><?//= $form->field($model, 'task')->label( Yii::t('main', 'Majburiyatlari') )->textarea(); ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                if($model->image && file_exists(Yii::getAlias('@frontend') . '/web' . Yii::$app->params['uploads_url'] . Yii::$app->controller->id . '/' . $model->id . '/m_' . $model->image )) {
                    ...
                    <img class="image_preview postImage" data-title="<?=$model->fio ?>" data-img="<?= Yii::$app->params['frontend'] . Yii::$app->params['uploads_url'] . Yii::$app->controller->id . '/' . $model->id . '/l_' . $model->image ?>"src="<?= Yii::$app->params['frontend'] . Yii::$app->params['uploads_url'] . Yii::$app->controller->id . '/' . $model->id . '/m_' . $model->image ?>"/>
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'leader-resume', {
...
<script type="text/javascript">
    var editor = CKEDITOR.replace( 'leader-task', {
        filebrowserBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=files',
        filebrowserImageBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=images',
        filebrowserFlashBrowseUrl : '/kcfinder/browse.php?opener=ckeditor&type=flash',
        filebrowserUploadUrl : '/kcfinder/upload.php?opener=ckeditor&type=files',
