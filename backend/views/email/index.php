...
$this->title = Yii::t('main', 'Subscribers');
        ...
        <div class="panel-body no-padding">
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Send'), ['/email/send'], ['class' => 'btn btn-success']) ?>
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'contentOptions' => ['class' => 'v-align-middle', 'style' => 'text-align:left'],
                                    'label' => Yii::t('main', 'Subscribe date'),
                                    'content' => function( $model ){
                                        return date('d/m/y h:m', strtotime( $model->created_date));
                                    }
                                ],
                                [
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/email/index']);?>
