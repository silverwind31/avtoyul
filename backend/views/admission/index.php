        ...
        <div class="panel-body no-padding">
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Admission'), ['/admission/create'], ['class' => 'btn btn-success']) ?>
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'content' => function($data){
                                        return substr($data->level_name, 0 , 35).'...';
                                    }
                                ],
                                [
                                    'attribute' => 'name',
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/admission/index']);?>
