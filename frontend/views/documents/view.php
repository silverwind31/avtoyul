...
$this->title = \common\components\StaticFunctions::getSettings('title') . " - " . \common\models\ProjectCategory::findOne($model->category)->getLang('name') . "-" . $model->getLang('name');
            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="portfolio-meta">
                    <ul>
                        ...
                        <li><i class="fa fa-file"></i><span><?=Yii::t('main','project_file')?></span> <b><?=$model->getLang('file')?></b></li>
                    </ul>
                </div>
            </div>
        </div>
