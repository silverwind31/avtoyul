            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="portfolio-meta">
                    <ul>
                        ...
                        <?php if(!empty(\common\models\ProjectCategory::findOne($model->category))): ?>
                        <li><i class="fa fa-tag"></i><span><?=Yii::t('main','project_category')?></span> <b><a href="<?=yii\helpers\Url::to(['projects/by-cat','id'=>$model->category])?>"><?= \common\models\ProjectCategory::findOne($model->category)->name ?></a></b></li>
                        <?php endif; ?>
                        ...
                        <li><i class="fa fa-map-marker"></i><span><?=Yii::t('main','project_address')?></span> <b><?=$model->getLang('address')?></b></li>
                                ...
                                if($model->file && file_exists(Yii::getAlias('@frontend') . '/web' . Yii::$app->params['uploads_url'] . 'project/' . $model->id . '/' . $model->file )) {



                                    $file = Yii::$app->params['frontend'] . Yii::$app->params['uploads_url'] . 'project/' . $model->id . '/' .  $model->file;
                                ...
                                <?php if(!empty($file)): ?>
                                    ...
                                    <li><i class="fa fa-file"></i><span>

                                    <a target="_blank" href="<?=$file?>" class="btn btn-success"><i class="fa fa-download"></i> <?=Yii::t('main','project_file')?> </a>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="single-content">
                    ...
                    <p><?=\common\components\StaticFunctions::kcfinder($model->getLang('description'))?></p>
