            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-envelope"></i> Bosh boshqarma tomonidan xujjatlar (xat, topshiriq, qaror, farmoyish, bayonlar) ijrosi to‘g‘risida
                    ...
                    <div class="panel-body container-items"><!-- widgetContainer -->
                        <?php foreach ($reportsData as $index => $data): ?>
                            <div class="item panel offer-bg"><!-- widgetBody -->
                                <div class="panel-heading">
                                    <span class="panel-title-address">Xujjat: <?= ($index + 1) ?></span>
                                ...
                                <div class="panel-body">
                                    ...
                                    <?= $form->field($data, "[{$index}]send_date")->widget(DatePicker::classname(), [
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]send_number")->textarea(['maxlength' => true, 'rows' => 2]) ?>
                                        </div>
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]report_name")->textarea(['maxlength' => true, 'rows' => 2]) ?>
                                        </div>
                                    </div><!-- end:row -->

                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]deadline")->textarea(['maxlength' => true, 'rows' => 2]) ?>
                                        </div>
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]responsible_man")->textarea(['maxlength' => true, 'rows' => 2])?>
                                        </div>
                                    </div><!-- end:row -->

                                    <div class="row">
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]position")->textarea(['maxlength' => true, 'rows' => 2]) ?>
                                        </div>
                                        <div class="col-sm-12">
                                            <?= $form->field($data, "[{$index}]execution_state")->textarea(['maxlength' => true, 'rows' => 2]) ?>
                                        </div>
                                    </div><!-- end:row -->
