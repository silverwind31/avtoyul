...
/**
 * ReportFoydalanishgaQabulqilishSearch represents the model behind the search form of `common\models\ReportFoydalanishgaQabulqilish`.
 */
class ReportFoydalanishgaQabulqilishSearch extends ReportFoydalanishgaQabulqilish
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ReportFoydalanishgaQabulqilish::find();
